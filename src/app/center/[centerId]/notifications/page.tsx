...
export default function NotificationsPage() {
    ...
    useEffect(() => {
        ...
        // This effect runs once to determine the user's role.
    ...
    // This effect listens for notifications once the role is determined.
    useEffect(() => {
        if (!user) return;
    ...
    // Filter notifications for the current center for display
