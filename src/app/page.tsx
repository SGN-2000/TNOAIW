        ...
        if (snapshot.exists()) {
          snapshot.forEach((centerSnapshot) => {
            ...
            if (centerId && centerData.members) {
              const isAdmin = centerData.members.admins && centerData.members.admins[user.uid];
              const isStudent = centerData.members.students && centerData.members.students[user.uid];
