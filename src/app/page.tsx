                ...
                <CardContent>
                  {loading ? (
                    ...
                    <div className="text-center py-12 border-2 border-dashed rounded-lg">
                      <p className="text-muted-foreground">{user ? "Aún no te has unido a ningún centro." : "Inicia sesión para ver tus centros."}</p>
                       <p className="text-sm text-muted-foreground mt-1">
                          {user ? "¡Crea o únete a uno para empezar!" : <Button variant="link" asChild><Link href="/profile">Inicia sesión</Link></Button>}
                        </p>
                    </div>
                  )}
                </CardContent>
            ...
            <div className="space-y-8">
              <Card className="shadow-md">
                ...
                <CardContent className="flex flex-col space-y-4">
                  <Button asChild disabled={!user || profileComplete === false}>
                    <Link href="/create-center">
                      <Plus className="mr-2 h-4 w-4" /> Crear un Nuevo Centro
                    </Link>
                  </Button>
                  <Button asChild variant="secondary" disabled={!user || profileComplete === false}>
